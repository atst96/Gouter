...
internal static class MessagePackUtil
{
    ...
    /// </summary>
    private static readonly MessagePackSerializerOptions _messagePackOptions = MessagePack.Resolvers.StandardResolverAllowPrivate.Options;
    ...
    public static async ValueTask<T?> DeserializeFileAsync<T>(string path)
    {
    ...
    public static ValueTask<T> DeserializeAsync<T>(Stream stream)
        => MessagePackSerializer.DeserializeAsync<T>(stream, _messagePackOptions);
    ...
    public static async ValueTask SerializeFileAsync<T>(T @object, string path)
    {
    ...
    public static Task SerializeAsync<T>(T @object, Stream stream)
        => MessagePackSerializer.SerializeAsync(stream, @object, _messagePackOptions);
}
