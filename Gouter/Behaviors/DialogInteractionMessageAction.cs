...
internal class DialogInteractionMessageAction : InteractionMessageAction<FrameworkElement>
{
    ...
    protected override void InvokeAction(InteractionMessage message)
    {
        switch (message)
        {
            ...
            case TaskDialogMessage taskDialogMessage:
                this.TaskDialogMessage(taskDialogMessage);
                break;
        }
    }
    ...
    /// </summary>
    /// <param name="message"></param>
    private void TaskDialogMessage(TaskDialogMessage message)
    {
        _ = TaskDialog.ShowDialog(this._hwnd, message.TaskDialogPage);
    }
}
